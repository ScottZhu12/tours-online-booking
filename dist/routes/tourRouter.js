...
tourRouter.param('id', tourController_1.checkID);
// get() method and post() method share the same url
tourRouter.route('/').get(tourController_1.getAllTours).post(tourController_1.checkBody, tourController_1.createTour);
